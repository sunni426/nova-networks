...
def encode_mask(param):
  ...
  save_dir = f'{DIR_CFGS.DATA_DIR}/mask/train' # og: train
  print('image name:' ,img_name)
  cellmask=imageio.imread(f'{save_dir}/{img_name}_cellmask.png')
  print(f'{save_dir}/{img_name}_cellmask.png')
  print('CELLMASK', cellmask)
...
def generate_cellmask_csv(dataset, pool):
  ...
  # mask_df = encode_mask(params)
  # print(f'encode_mask: {encode_mask}')
    
  mask_df = pool.map(encode_mask, params)
 
  print('After Pool:', mask_df)  
  ...
  print('After CONCAT:',mask_df) #return NONE
  print(mask_df.head())
