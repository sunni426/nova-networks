...
class CellClsDataset(Dataset):
  ...
  def load_image(self, image_dir_list, image_id):
    ...
    for image_dir in image_dir_list:
      image = cv2.imread(f'{image_dir}/{image_id}', flags=cv2.IMREAD_UNCHANGED)
      #image = imageio.imread(f'{image_dir}/{image_id}.{self.args.suffix}', flags=cv2.IMREAD_UNCHANGED)
...
if __name__ == '__main__':
    ...
    d.istraining=True
    d.init_dataset
    d.load_image('.','.','0a3c588e-bbbe-11e8-b2ba-ac1f6b6435d0_yellow.png')
