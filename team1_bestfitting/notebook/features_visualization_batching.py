...
FEATURE_DIR    = '/kaggle_HPA/2021/data/HPA_SingleCellClassification_Analysis/team1_bestfitting/features'
DATA_DIR       = '/kaggle_HPA/2021/data/kaggle-dataset/PUBLICHPA'
DATASET        = 'train'
